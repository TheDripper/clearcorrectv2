    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
          <div class="doctor-registration bg-white my-12 max-w-6xl mx-auto py-12">
            <h2 class="text-pink text-center mb-16">Patient Registration</h2>
            <form id="patient-register" action="/patient-created" method="POST">
              ...
              <div class="flex items-center max-w-xl">
                ...
                <div class="flex">
                  ...
                  <div class="flex flex-col">
                    <p>I confirm that I have read and agree to the ClearCorrect Case Gallery <a href="/doctor-consent-agreement">Doctor Consent Agreement</a></p>
                  </div>
                </div>
              </div>
              ...
              <a class="text-center" href="/doctor-register">Switch to doctor registration.</a>
            </form>
          </div>
