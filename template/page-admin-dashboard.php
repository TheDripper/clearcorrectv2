  ...
  <section>
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
     ...
     <tr class="border-b border-border-grey">
                    ...
                    <td class="p-4 text-center"><?php echo wp_date('m/d/Y',get_post_timestamp()); ?></td>
                    <td class="p-4 text-center"><?php echo get_field('doctor', $id)->post_title; ?></td>
                    <td class="p-4 text-center"><?php echo $current_user->ID; ?></td>
                    <td class="p-4 text-center"><?php echo get_field('patient_case_number', $case->ID) ?></td>
                    <?php $region = wp_get_object_terms($case->ID, 'region')[0]->name; ?>
                    <td class="p-4 text-center"><?php echo $region; ?></td>
                    <td class="p-4 text-center"><?php echo $case->post_status; ?>
                    <td class="p-4 text-center">
                      <a class="publish text-sm mx-2" href="#">PUBLISH</a>|<a class="text-sm mx-2 delete" href="#">REJECT</a>
